...
#if CONFIG_MACH_STM32F0 || CONFIG_MACH_STM32G0 || CONFIG_MACH_STM32F2 || CONFIG_MACH_STM32F4
...
#define SPI_FUNCTION GPIO_FUNCTION((CONFIG_MACH_STM32F0 || CONFIG_MACH_STM32G0) ? 0 : 5)
